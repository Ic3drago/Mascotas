...
export const MascotasView: React.FC = () => {
  ...
  return (
    <RippleBackground
      imageUrl={'https://wallpapers.com/images/high/dark-animals-hqmawnyduljo4rri.webp'}
    ...
    >
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-4 py-8">
        <header className="flex justify-between items-center mb-10">
          <div> 
            <h1 className="text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-yellow-700 to-amber-100">
              GESTIÓN DE ANIMALES
            </h1>
          </div>
          ...
          <button 
            onClick={openAddForm}
            className="flex items-center gap-2 px-5 py-2.5 bg-yellow-900 hover:bg-indigo-700 text-white rounded-xl font-medium shadow-lg shadow-indigo-500/30 transition-all active:scale-95"
          >
            <Plus size={20} />
            Registrar Mascota
          </button>
